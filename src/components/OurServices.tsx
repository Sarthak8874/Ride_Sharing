        ...
        <div>
            ...
            <div className="flex flex-wrap  gap-10 mx-auto items-center justify-center">
                <CardContainer className="inter-var ">
                    <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem]  rounded-xl p-6 border md:h-[600px] h-[400px]  ">
                        <CardItem
                            translateZ="50"
                        ...
                        <CardItem translateZ="100" className="w-full mt-4">
                            <Image
                                ...
                                height="100"
                                width="100"
                                className="h-auto scale-75 w-full object-cover rounded-xl group-hover/card:shadow-xl"
                                alt="thumbnail"
                            />
                        </CardItem>
                ...
                <CardContainer className="inter-var">
                    <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-[600px] rounded-xl p-6 border  ">
                        <CardItem
                            translateZ="50"
                            className="text-xl font-bold text-black dark:text-white"
                        >
                        ...
                        <CardItem translateZ="100" className="w-full mt-4">
                            <Image
                                ...
                                height="800"
                                width="800"
                                className="h-auto w-full object-cover rounded-xl bg-transparent border-none -my-[6] group-hover/card:shadow-xl"
                                alt="thumbnail"
                            />
                        </CardItem>
                    </CardBody>
